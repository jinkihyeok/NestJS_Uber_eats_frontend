...
} & { " $fragmentName"?: "DishPartsFragment" };
...
export type OrderPartsFragment = {
  ...
  createdAt: any;
  total?: number | null;
} & { " $fragmentName"?: "OrderPartsFragment" };
...
} & { " $fragmentName"?: "FullOrderPartsFragment" };
  ...
  definitions: [
    {
      ...
      name: { kind: "Name", value: "DishParts" },
      typeCondition: {
        kind: "NamedType",
...
} as unknown as DocumentNode<DishPartsFragment, unknown>;
export const OrderPartsFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "OrderParts" },
      typeCondition: {
        kind: "NamedType",
...
} as unknown as DocumentNode<OrderPartsFragment, unknown>;
export const FullOrderPartsFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "FullOrderParts" },
      typeCondition: {
        kind: "NamedType",
        name: { kind: "Name", value: "Order" },
      },
...
} as unknown as DocumentNode<FullOrderPartsFragment, unknown>;
export const VerifiedUserFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
...
} as unknown as DocumentNode<VerifiedUserFragment, unknown>;
export const EditedUserFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "EditedUser" },
      typeCondition: {
        kind: "NamedType",
        name: { kind: "Name", value: "User" },
      },
...
} as unknown as DocumentNode<EditedUserFragment, unknown>;
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "GetOrderInput" },
            },
          },
        },
      ],
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "EditOrderInput" },
            },
          },
        },
      ],
...
} as unknown as DocumentNode<EditOrderMutation, EditOrderMutationVariables>;
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "CreateDishInput" },
            },
          },
        },
      ],
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "CreateRestaurantInput" },
            },
          },
        },
      ],
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "MyRestaurantInput" },
            },
          },
        },
      ],
